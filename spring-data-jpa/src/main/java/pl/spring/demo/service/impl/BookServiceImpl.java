...
public class BookServiceImpl implements BookService {
	...
	public BookTo saveBook(BookTo book) {
		if (!book.getLibraryId().equals(null)) {
			LibraryEntity libraryEntity = libraryRepository.getOne(book
					.getLibraryId());
	...
	@Override
	public List<BookTo> findAllBooksFromLibrary(long libraryId) {
		return BookMapper.map2To(bookRepository.findAllBooksFromLibrary(libraryId));
	}
