...
public class BookRepositoryTest {
	...
	public void testShouldFindBooksByTitle() {
		...
		// when
		List<BookEntity> booksEntity = bookRepository
	...
	public void testShouldDeleteBook() {
		BookTo bookTo = new BookTo(null, "Alice in Wonderland", "Lewis Carroll");
		BookEntity testBook = bookRepository.save(BookMapper.map(bookTo));
